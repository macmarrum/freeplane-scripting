 ...
 *  - plain text
 *  In case of HTML, when node-core's Format is Markdown or Text,
 ...
 */
final SCRIPT_NAME = 'pasteToCore'
def node = ScriptUtils.node()
// [MarkdownRenderer.MARKDOWN_FORMAT, PatternFormat.IDENTITY_PATTERN]
def isOutcomeToContainTagsHtmlBody = node.format !in ['markdownPatternFormat', 'NO_FORMAT']
...
if (text) {
    ScriptUtils.c().selecteds.each { it.text = text }
}
